...
var Clock = function (_React$Component) {
  ...
  function Clock() {
    ...
    _this.requestTime = new Date();
    _this.date = _this.requestTime.toDateString();
    _this.time = _this.requestTime.toTimeString().slice(0, 8);
    _this.state = { date: _this.date, time: _this.time };
  ...
  _createClass(Clock, [{
    key: 'tick',
    value: function tick() {
      var requestTime = this.requestTime;
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              "h1",
              { onClick: this.changeState0.bind(this) },
              this.tabs[0].title
            ),
            _react2.default.createElement(
              "h1",
              { onClick: this.changeState1.bind(this) },
              this.tabs[1].title
            ),
            _react2.default.createElement(
              "h1",
              { onClick: this.changeState2.bind(this) },
              this.tabs[2].title
            )
          )
        ),
    ...
    key: "changeState2",
    value: function changeState2() {
      this.setState({ selected: 2 });
    }
  }, {
    key: "changeState0",
    value: function changeState0() {
      this.setState({ selected: 0 });
    }
  }, {
    key: "changeState1",
    value: function changeState1() {
...
var Root = function Root() {
  var tabs = [{ title: "One", content: "racing cars are cool" }, { title: "Two", content: "Elon Musk is cool" }, { title: "Three", content: "all submarines are yellow" }];
  return _react2.default.createElement(
    'div',
    null,
...
var Weather = function (_React$Component) {
  ...
  function Weather() {
    ...
    _this.state = { lat: null, long: null };
    return _this;
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h4',
          null,
          'Your longitude is ' + this.state.long
        )
      );
    }
  }, {
    key: 'setCoordinates',
    value: function setCoordinates(pos) {
      var crd = pos.coords;
